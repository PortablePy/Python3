...
class Action(Enum):
    ...
    Args:
        enum.Enum: Inherits from Enum class from enum package
    """
...
class Topology(typing.NamedTuple):
    ...
    Args:
        typing.Namedtuple: Topology inherits from the Namedtuple
    """
...
class Session(typing.NamedTuple):
    ...
    Args:
        typing.NamedTuple: session, pin, channel tuple inherits from NamedTuple
    ...
    def info(self, route_value: str, action: Action, timeout: int):
        ...
        if action == Action.Disconnect_All:
            ...
            midpoint = self.Session.can_connect(
                self.Channel, route_value
            )  # TODO Function Failing due to type issues
...
@nitsm.codemoduleapi.code_module
def initialize_sessions(tsm: SMContext, lock: Lock = None):
    """
